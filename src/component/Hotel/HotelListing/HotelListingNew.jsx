...
import HotelsListData from "../Hotels/HotelsListData";
import FilterComp from "../Hotels/FilterComp";
import { FaAngleRight, FaSpinner, FaStar } from "react-icons/fa";
import { Link } from "react-router-dom";
import { IoLocationOutline } from "react-icons/io5";
import { BiSolidOffer } from "react-icons/bi";
import "./HotelListingNew.css";

const HotelListingNew = () => {
                                ...
                                <div className="listing_hd_hotel">
                                  ...
                                  <div className="coupon">
                                    <div className="coupon_code">
                                      <BiSolidOffer className="couponcode_icon" />
                              ...
                              <div className="pribtns ">
                                ...
                                <div className="hotslc ">
                                  <Button
                                    ...
                                    hid={hotel.id}
                                    sid="vlybtof6uqploztqrvh3hafviq"
                                    className="btn-grad ftbtn_src openrooms hotelling_btn"
                                  >
                                    Show Rooms
                                    <FaAngleRight
                                      className="ml5"
...
export default HotelListingNew;
