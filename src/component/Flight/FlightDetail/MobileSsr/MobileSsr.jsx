...
const MobileSsr = ({
  ...
  return (
    <div className="mobile_ssr_container">
        ...
        <div className="ancillary-header">
          <div className="ancillary-head">
            <p
              ...
              style={{ width: "73%" }}
              onClick={() => setSsrModal(false)}
            >
              <a className="hdrBackArrow" style={{ position: "static" }}>
                <span className="backIcon" />
              </a>
              <span className="font16">Add-ons</span>
            </p>
            <span
              className="blueTxt"
              style={{
          ...
          <div className="fli-tabs">
            <span
              className="fli-tabs-item active"
      ...
      <div className="stick_filter_nv1_mobile bb">
        ...
        <div className="col_5_nv1 return-top" onClick={handlePayment}>
