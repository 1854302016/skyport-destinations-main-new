    ...
    <div>
      ...
      <section className="section_padding">
        <Container>
          <div className="text-center">
            <h2>
              <b>About Trade Fare Destinations</b>
            </h2>
          </div>
        </Container>
      </section>
      {/* <section className="section_padding">
        ...
        <Row className="d-flex align-items-center">
            ...
            answering the quiet call of adventure — Trade Fare Destinations is your passport to the world.
            Trade Fare Destinations is a premium online travel agency specializing exclusively in global flight
            ...
            <div className="col-lg-6">
              <div className="about-content mb-4">
                <h6 className="text-primary fs-14 fw-medium mb-2">
                  About Trade Fare Destinations
                </h6>
                <h2 className="display-6 mb-2">
                  Global Flight Bookings Made Effortless with Trade Fare Destinations!
                </h2>
        ...
        <div className="container">
          <div className="about-new-sec" style={{ width: '950px', margin: 'auto' }}>
            ...
            <p className="text-white" style={{ fontSize: '16px', lineHeight: "25px" }}>
              ...
              Caribbean, Trade Fare Destinations is driven by a vision to become the leading name in digital air
              ...
              Trade Fare Destinations represents a new standard in flight booking — built for scale, powered by
              trust, and committed to delivering travel solutions that match the speed and ambition of the
              modern world.
              At Trade Fare Destinations, we don’t just book flights — we open the skies to your next story.
            </p>
