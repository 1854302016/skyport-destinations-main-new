    ...
    <>
      ...
      {destinations && destinations.length > 0 ? (
        <div>
          ...
          <div className="container-fluid overflow-hidden m-0 p-0">
            <Row className="justify-content-center g-4">
              ...
              {/* <div className="custom-next" onClick={() => swiperRef.current?.slidePrev()}>
              <FaChevronRight />
            </div>
            <div className="custom-prev" onClick={() => swiperRef.current?.slideNext()}>
              <FaChevronLeft />
            </div> */}
            </Row>
          </div>
